		...
		<form action="memberUpdateResult" name="memberUpdateForm" method="post" id="memberUPdateForm">
			...
			<div class="row my-3">
				<div class="col-8 offset-2">
					...
					<div class="row">
						<div class="col-4">
							<input type="text" class="form-control" name="zipcode" id="zipcode" maxlength="5" readonly value="${sessionScope.member.zipcode}">
						</div>
						<div class="col-4">
			...
			<div class="row my-3">
				<div class="col-8 offset-2">
					...
					<input type="text" class="form-control" name="address1" id="address1"  readonly value="${sessionScope.member.address1}">
				</div>	
			</div>
			<div class="row my-3">
				<div class="col-8 offset-2">
					<label for="address2" class="form-label">상세주소 : </label>				
					<input type="text" class="form-control" name="address2" id="address2" value="${sessionScope.member.address1}">
				</div>
			</div>
			<div class="row my-3">
				<div class="col-8 offset-2">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<select class="form-select" name="selectDomain" id="selectDomain">
								...
								<option ${sessionScope.member.email.split('@')[1] == 'hanmail.net' ? 'selected' : ''}>한메일</option>
								<option ${sessionScope.member.email.split('@')[1] == 'gmail.com' ? 'selected' : ''}>구글</option>
							</select>
						</div>
					</div>
				</div>	
			...
			<div class="row my-3">
				<div class="col-8 offset-2">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" name="mobile2" id="mobile2" maxlength="4" value="${sessionScope.member.mobile.split('-')[1]}">
						</div>-
						<div class="col-md-4">
							<input type="text" class="form-control" name="mobile3" id="mobile3" maxlength="4" value="${sessionScope.member.mobile.split('-')[02]}">
						</div>
					</div>
				</div>
			</div>			
					...
					<div class="row">
						<div class="col-md-3">
							<select class="form-select" name="phone1" id="phone1">
								...
								<option ${member.phone.split('-')[0] == '031' ? 'selected' : ''}>031</option>
								<option ${member.phone.split('-')[0] == '032' ? 'selected' : ''}>032</option>
								<option>033</option>
								<option>041</option>
								<option>042</option>
								<option>043</option>
						...
						<div class="col-md-4">
							<input type="text" class="form-control" name="phone2" id="phone2" maxlength="4" value="${member.phone.split('-')[1]}">
						</div> - 
						<div class="col-md-4">
							<input type="text" class="form-control" name="phone3" id="phone3" maxlength="4" value="${member.phone.split('-')[2]}">
						</div>
					</div>
				</div>	
			</div>			
