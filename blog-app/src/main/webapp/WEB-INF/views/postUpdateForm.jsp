...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-lg-8 mx-auto">
            ...
            <article>                
                <header class="mb-5">                    
                    <h1 class="fw-bolder mb-1">블로그 포스트 수정하기</h1>                    
                </header>
                <form action="postUpdateProcess" method="post" id="postUpdateForm" 
                	enctype="multipart/form-data">
                	<input type="hidden" name="postNo" value="${ post.postNo }" >                	
					<div class="mb-3">
						<label for="title" class="form-label">포스트 제목 : </label>
					  	<input type="text" class="form-control" name="title" 
					  		id="title" aria-describedby="titleHelp" value="${post.title}">
					...
					<div class="mb-3">
						...
						<label for="writer" class="form-label">작성자 : </label>
					  	<input type="text" class="form-control text-secondary" 
					  		name="writer" id="writer" value="${post.writer}" readonly>
					</div>
					<div class="mb-3">
						...
						<c:forEach var="c" items="${ categoryList }">
							<option value="${c.categoryNo}" 
								${c.categoryNo == post.categoryNo ? "selected": ""}>
